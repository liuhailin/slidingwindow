...
func NewLimiter(size time.Duration, limit *LimitProvider, newWindow NewWindow) (*Limiter, StopFunc) {
...
func (lim *Limiter) AllowN(now time.Time, n int64) bool {
	...
	if count+n > lim.limit.dynamicLimit {
		return false
	}
